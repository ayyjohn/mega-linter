...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hxx', 'h', 'cu', 'cxx', 'h++', 'hpp', 'c++', 'cpp', 'hh', 'cc', 'c', 'cuh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hxx,h,cu,cxx,h++,hpp,c++,cpp,hh,cc,c,cuh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hxx', 'h', 'h++', 'hpp', 'hh', 'cuh'} will be assumed to be headers)

      Examples:
        --headers=hxx,h,h++,hpp,hh,cuh
        --headers=hpp,hxx
        --headers=hpp
...
See documentation on https://nvuillam.github.io/mega-linter/descriptors/c_cpplint/
-----------------------------------------------
